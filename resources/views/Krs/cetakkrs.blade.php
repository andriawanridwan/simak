...
<body onload="window.print()">
    ...
    <table class="table borderless">
        <tr>
            ...
            <td width="2%">:</td>
            <td>{{$krs[0]->mahasiswa->nama}}</td>
        </tr>
        <tr>
            <td width="15%">NIM / semester</td>
            <td width="2%">:</td>
            <td>{{$krs[0]->mahasiswa->nim}} / {{substr($mahasiswa->tahun_akademik->tahun_akademik,4) }}</td>
        </tr>
        <tr>
            <td width="15%">Program Studi</td>
            <td width="2%">:</td>
            <td>{{$mahasiswa->mahasiswa->prodi->prodi}}</td>
        </tr>
        <tr>
            <td width="15%">Konsentrasi</td>
            <td width="2%">:</td>
            <td>{{$mahasiswa->mahasiswa->konsentrasi->konsentrasi}}</td>
        </tr>
    </table>
