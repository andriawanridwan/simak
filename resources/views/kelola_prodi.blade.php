    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form method="POST" action="{{ url('/simpan_prodi') }}">
            @csrf
            <div class="modal-body">
              <div class="form-row">
                <div class="col-12 mb-4">
                  <input class="form-control" required="" type="text" placeholder="Prodi" name="prodi">
                </div>
              </div>
            </div>
                ...
                <td class="text-right">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                      <a class="dropdown-item  edit-btn" data-toggle="modal" data-target="#editModal" id="{{ $pro->id }}">Edit</a>
                      <a class="dropdown-item" href="{{ url('/hapus_prodi/'.$pro->id) }}">Hapus</a>
                    </div>
                  </div>
                </td>
              </tr>
